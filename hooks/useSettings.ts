...
import { adminSettingsAPI, Setting, UpdateSettingsData } from "@/lib/api";
...
export const useSettings = (
  ...
  // Use ref to track if we have already loaded settings
  ...
  const saveSettings = useCallback(async () => {
    ...
    try {
      ...
      const response = await adminSettingsAPI.updateSettings(settingsData);
  ...
  }, [initialSettings]); // Do not include refreshSettings to avoid loops
