...
const LinkIcon = () => (
  ...
  >
    <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7-7l-1.72 1.72" />
...
export default function App() {
  ...
  const handlePublish = () => {
    ...
    if (feather === "Photo" && photos.length === 0) {
      setNotification({
        type: "error",
    ...
    if (feather === "Video" && videos.length === 0) {
      setNotification({
        type: "error",
    ...
    if (feather === "Audio" && audios.length === 0) {
      setNotification({
        type: "error",
