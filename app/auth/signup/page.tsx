        ...
        <form onSubmit={handleSignUp}>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                className="shadow-sm appearance-none border border-default rounded-xl w-full py-3 pl-10 pr-12 text-text-primary leading-tight focus:outline-none focus:shadow-outline bg-surface transition-colors duration-300 hover:bg-surface-elevated focus:bg-surface-elevated focus:ring-2 focus:ring-primary focus:ring-opacity-50"
                id="password"
          ...
          <div className="flex items-center justify-between">
            <button
              type="submit"
              className="w-full bg-primary hover:bg-secondary text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={
